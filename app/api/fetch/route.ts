...
export async function POST(request: NextRequest) {
  ...
  // The homepage materialized views (ranking_7d_mv / ranking_breakdown_7d_mv)
  // are refreshed by a pg_cron job inside Postgres every 10 min — doing it here
  // over the API hits the ~8s statement timeout, so it's handled in-DB instead.
